...
ALTER TABLE decks ADD COLUMN event_name text;
ALTER TABLE decks ADD COLUMN event_date date;
ALTER TABLE decks ADD COLUMN placing integer;

CREATE INDEX idx_decks_event_date ON decks (event_date) WHERE event_date IS NOT NULL;
