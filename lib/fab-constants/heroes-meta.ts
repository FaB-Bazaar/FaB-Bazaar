...
export const TALISHAR_HERO_SLUGS: Record<string, string> = {
  ...
  'viserai, the forsaken':               'viserai_the_forsaken',
  'malice, domina of the dead':          'malice_domina_of_the_dead',
  ...
  'florian':                             'florian',
  'viserai':                             'viserai',
  'viserai, between worlds':             'viserai_between_worlds',
  'malice':                              'malice',
  'vynnset':                             'vynnset',
  'chane':                               'chane',
...
export const TALISHAR_HERO_IDS: Record<string, string> = {
  ...
  'viserai, the forsaken':               'IAR106',
  'malice, domina of the dead':          'IAR053',
