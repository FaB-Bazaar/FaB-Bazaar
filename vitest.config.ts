    ...
    projects: [
      {
        ...
        test: {
          environment: 'jsdom',
          include: ['components/**/*.test.{ts,tsx}', 'app/admin/**/*.test.{ts,tsx}', 'app/volzar/**/*.test.{ts,tsx}', 'app/daily/**/*.test.{ts,tsx}', 'app/*.test.{ts,tsx}', 'app/auth/**/*.test.{ts,tsx}'],
          // --- ADD THIS LINE ---
      ...
      },
      {
        ...
        test: {
          environment: 'node',
          include: ['security/**/*.test.ts', 'app/api/**/*.test.ts', 'app/discord-v2/**/*.test.ts', 'app/stores/**/*.test.ts', 'app/wants/**/*.test.ts', 'app/oauth/**/*.test.ts', 'app/overlay/**/*.test.ts', 'models/**/*.test.ts', 'lib/**/*.test.ts', 'web-components/src/**/*.test.ts'],
          setupFiles: ['./vitest.setup.ts'],
          alias: {
            '@': path.resolve(__dirname, './'),
          },
