  ...
  return (
    <Card>
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-bold text-center">Login with Discord</CardTitle>
        <CardDescription className="text-center">You need a Discord account to use this platform</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <a href="https://discord.com/register" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
            Create one here
          </a>
        </p>
      </CardContent>
