          ...
          properties: {
            ...
            filters: {
              ...
              properties: {
                ...
                foilings:         { type: 'array', items: { type: 'string', enum: ['s','r','c','g'] }, description: 's=NonFoil(Standard) r=RainbowFoil c=ColdFoil g=GoldFoil — NF→["s"], RF→["r"], CF→["c"]' },
                ...
                raritiesNot:  { type: 'array', items: { type: 'string', enum: ['c','r','s','m','l','f','t','p','v'] } },
                foilingsNot:  { type: 'array', items: { type: 'string', enum: ['s','r','c','g'] } },
                editionsNot:  { type: 'array', items: { type: 'string', enum: ['a','f','u','n'] } },
