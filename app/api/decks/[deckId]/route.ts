...
export async function GET(
  ...
  try {
    ...
    // Private notes (gamePlan / cardNotes / matchupNotes) are owner/co-owner only.
    const safeMetadata =
      canEdit || !deck.metadata
        ? deck.metadata
        : { ...deck.metadata, gamePlan: undefined, cardNotes: undefined, matchupNotes: undefined };
