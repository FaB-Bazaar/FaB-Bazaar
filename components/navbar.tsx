    ...
    if (user) {
      ...
      return (
        <Link href="/auth/login">
          <Button variant="outline" size="sm" className="flex items-center border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
  ...
  const renderCollectionDropdown = () => {
    ...
    return (
      <DropdownMenu onOpenChange={(open) => open && loadBindersOnDemand()}>
        ...
        <DropdownMenuContent align="start" className="w-80 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <DropdownMenuItem asChild>
          ...
          <div className="md:hidden border-t dark:border-gray-700 bg-white dark:bg-gray-800">
            <div className="container mx-auto px-4 py-2">
              ...
              <div className="space-y-1 py-2">
                ...
                {/* Sets */}
                <Link href="/sets" onClick={() => setIsMenuOpen(false)}>
                ...
                {/* Discord - Standalone Link */}
                <Link href="/discord" onClick={() => setIsMenuOpen(false)}>
                  <div className="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
