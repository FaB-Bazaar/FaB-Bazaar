...
export default function Navbar() {
  ...
  // instead of their default landing page. safeCallbackUrl skips auth pages
  // (no loops); '/' keeps the landing-page default.
  const loginCallback = safeCallbackUrl(pathname)
  const loginHref =
    loginCallback && loginCallback !== "/"
      ? `/auth/login?callbackUrl=${encodeURIComponent(loginCallback)}`
      : "/auth/login"
