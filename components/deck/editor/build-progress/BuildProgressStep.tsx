...
const ACCENT_BORDER: Record<BuildProgressStepProps["accent"], string> = {
  amber: "border-amber-400 dark:border-amber-500/40 hover:border-amber-500 dark:hover:border-amber-400",
  red: "border-red-400 dark:border-red-500/40 hover:border-red-500 dark:hover:border-red-400",
  blue: "border-blue-400 dark:border-blue-500/40 hover:border-blue-500 dark:hover:border-blue-400",
  violet: "border-violet-400 dark:border-violet-500/40 hover:border-violet-500 dark:hover:border-violet-400",
};
  ...
  return (
    ...
    >
      <div className="flex w-full items-center gap-2">
        ...
        {complete && (
          <Check className="ml-auto h-4 w-4 text-green-700 dark:text-green-400" aria-hidden="true" />
        )}
      </div>
