// scripts/optimize-strategy-portraits.ts
// Generate .webp variants of every archetype/strategy portrait PNG under public/strategies/.
// Run with: npx tsx scripts/optimize-strategy-portraits.ts
// Mirrors scripts/optimize-hero-portraits.ts.
...
async function main() {
  const dir = path.resolve(process.cwd(), 'public/strategies');
